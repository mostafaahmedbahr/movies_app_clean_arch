...
class FetchTopRatedMoviesUseCase extends UseCaseWithNoParam<List<MovieEntity>>
{
  final BaseMovieRepo baseMovieRepo;
  FetchTopRatedMoviesUseCase(this.baseMovieRepo);

  @override
  Future<Either<Errors, List<MovieEntity>>> call() async {
    return await baseMovieRepo.fetchTopRatedMovies();
