...
class FetchPopularMoviesUseCase extends UseCaseWithNoParam<List<MovieEntity>>
{
  final BaseMovieRepo baseMovieRepo;
  FetchPopularMoviesUseCase(this.baseMovieRepo);

  @override
  Future<Either<Errors, List<MovieEntity>>> call() async {
    return await baseMovieRepo.fetchPopularMovies();
